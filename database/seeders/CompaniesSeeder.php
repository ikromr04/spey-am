...
class CompaniesSeeder extends Seeder
{
  ...
  public function run()
  {
    $companies = array(
      ...
      array('id' => '5', 'quantity' => '20', 'en_title' => 'Countries of presence', 'ru_title' => 'Стран присутствия', 'en_text' => 'Large regular deliveries of SPEY products are carried out in 5 regions of the world, such as Europe, Africa, Latin America, Southeast Asia and Central Asia.', 'ru_text' => 'Крупные регулярные поставки продукции SPEY ведутся в 5 регионах мира, таких как Европа, Африка, Латинская Америка, Юго-Восточная Азия и Средняя Азия.', 'trashed' => '0', 'created_at' => '2022-02-11 18:29:56', 'updated_at' => '2022-02-11 18:29:56')
    );
