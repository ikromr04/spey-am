...
class ValuesSeeder extends Seeder
{
  ...
  public function run()
  {
    $values = array(
      ...
      array('id' => '6', 'en_title' => 'Relationship', 'ru_title' => 'Отношение', 'en_text' => 'We value everyone\'s opinion.', 'ru_text' => 'Мы ценим мнение каждого.', 'trashed' => '0', 'created_at' => '2022-02-11 18:29:56', 'updated_at' => '2022-02-11 18:29:56')
    );
